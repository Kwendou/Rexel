			...
			<u><b>Clubs</b></u> :
				...
				<div>
					<div class="table-responsive">
						...
						$query = "SELECT c.CLUB_ID,c.NOM_CLUB,u.USER_ID,u.NOM,u.PRENOM,u.EMAIL FROM `$db_database`.clubs c LEFT JOIN `$db_database`.utilisateurs u ON u.USER_ID = c.RESPONSABLE";
						// Process DB query
