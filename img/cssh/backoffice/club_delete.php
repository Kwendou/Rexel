	...
	<div class="container">
		<div class="login-form">
			...
			<div class="form-signin">
				<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" role="form" id="register-form">
					<center><label for="delete">Voulez-vous r&eacuteellement supprimer ce club ?</label><br><br>
