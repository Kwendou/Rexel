  ...
  <body>
	<div class="container">
		...
		<div class="login-form">
			...
			<form method="post" action="club_delete.php" class="form-delete" role="form" >
				<input name="CLUB_ID" id="club_id" type="hidden" class="form-control" placeholder="club_id" value=" <?php echo $_POST['CLUB_ID']; ?>">
				<button id="supprimer" class="btn btn-block bt-login" type="submit">Supprimer le club</button>				
			</form>

			<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-register" role="form" >
				<div id="centre">
					<input name="CLUB_ID" id="club_id" type="hidden" class="form-control" placeholder="club_id" value=" <?php echo $_POST['CLUB_ID']; ?>">
